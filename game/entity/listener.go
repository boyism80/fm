...
type CharacterListener interface {
	...
	OnMobMoved(mob *Mob, isAggroed bool, centerSplit int8, skill1 uint8, skill2 uint8, skill3 uint8, skill4 uint8, startPoint types.Vector2[int16], movements []dto.MoveFragment)
	OnPlayerMove(character *Character, startPoint types.Vector2[int16], fragments []dto.MoveFragment)
	OnAttack(character *Character, attackInfo dto.AttackInfo, skillLevel uint8)
