-- Skill name (String.wz/Skill.img.xml): 라이트닝

function on_activated_15001004(me, skill, params)
...
function on_buff_15001004(me, skill)
	local effect = skill:effect()
	if effect == nil then
		return
	end
...
function on_unbuff_15001004(me, skill)
	local wz = skill:wz()
