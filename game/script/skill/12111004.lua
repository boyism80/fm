-- Skill name (String.wz/Skill.img.xml): 이프리트

function on_activated_12111004(me, skill, params)
...
function on_buff_12111004(me, skill)
	local effect = skill:effect()
	if effect == nil then
		return
	end
...
function on_unbuff_12111004(me, skill)
	local wz = skill:wz()
