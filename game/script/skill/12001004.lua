-- Skill name (String.wz/Skill.img.xml): 플레임

function on_activated_12001004(me, skill, params)
...
function on_buff_12001004(me, skill)
	local effect = skill:effect()
	if effect == nil then
		return
	end
...
function on_unbuff_12001004(me, skill)
	local wz = skill:wz()
