...
type CharacterListener interface {
	...
	OnAllianceUpdateInfo(ch *Character)
	...
	OnAllianceInvite(ch *Character, inviterGuildID uint32, inviterName string, allianceName string)
	OnAllianceCreate(ch *Character, info *dto.AllianceInfo, guilds []*dto.GuildInfo, membershipGuilds []dto.AllianceMembershipChangeGuild)
	OnAllianceDisband(ch *Character, allianceID uint32)
	OnAllianceInfoBroadcast(ch *Character, info *dto.AllianceInfo)
	OnAllianceNoticeChanged(ch *Character, info *dto.AllianceInfo)
	OnAllianceLeaderChanged(ch *Character, allianceID uint32, oldLeaderID uint32, newLeaderID uint32, info *dto.AllianceInfo, guilds []*dto.GuildInfo)
	OnAllianceMemberRankChanged(ch *Character, info *dto.AllianceInfo, guilds []*dto.GuildInfo)
	OnAllianceGuildAdded(ch *Character, info *dto.AllianceInfo, guilds []*dto.GuildInfo, newGuildID uint32, addedGuild *dto.GuildInfo, members []dto.AllianceGuildMemberRank, joining bool, membershipGuild *dto.AllianceMembershipChangeGuild)
	OnAllianceGuildLeft(ch *Character, info *dto.AllianceInfo, removedGuildID uint32, removedGuild *dto.GuildInfo, removedMembers []dto.AllianceGuildMemberRank, expelled bool, leaving bool)
	...
	OnAllianceMemberFieldsChange(ch *Character, allianceID uint32, guildID uint32, subjectCharacterID uint32, level uint32, classID uint32)
	...
	OnShowQuestCompletion(ch *Character, questID uint32)
	OnPlaySound(ch *Character, sound string, broadcast bool)
	OnPlayPortalSound(ch *Character)
	...
	OnFieldRelocate(ch *Character, spawnPoint uint8)
...
type MobListener interface {
	...
	OnMobAllyDamaged(mob *Mob, amount int32)
