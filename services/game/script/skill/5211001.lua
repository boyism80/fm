-- Skill name (String.wz/Skill.img.xml): 옥토퍼스

function on_activated_5211001(me, skill, params)
...
function on_buff_5211001(me, skill)
	local effect = skill:effect()
	if effect == nil then
		return
	end
...
function on_unbuff_5211001(me, skill)
	local wz = skill:wz()
