-- Skill name (String.wz/Skill.img.xml): 소울

function on_activated_11001004(me, skill, params)
...
function on_buff_11001004(me, skill)
	local effect = skill:effect()
	if effect == nil then
		return
	end
...
function on_unbuff_11001004(me, skill)
	local wz = skill:wz()
