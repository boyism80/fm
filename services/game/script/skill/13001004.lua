-- Skill name (String.wz/Skill.img.xml): 스톰

function on_activated_13001004(me, skill, params)
...
function on_buff_13001004(me, skill)
	local effect = skill:effect()
	if effect == nil then
		return
	end
...
function on_unbuff_13001004(me, skill)
	local wz = skill:wz()
