-- NPC name (String.wz/Npc.img.xml): 레드 벌룬
...
local NEXT_STAGE = 2
local EXP = 5000
local GUIDE = "안녕하세요. 첫번째 스테이지에 오신 것을 환영합니다. 맵 이곳 저곳을 돌아다니다 보면 여러 종류의 몬스터들을 찾을 수 있습니다. 이들을 모두 쓰러뜨리고 #b차원의 통행증 25장#k을 모아서 저에게 가져와 주시기 바랍니다. 차원의 통행증을 얻으면 파티장이 얻은 것을 모두 모아서 저에게 가져와 주시면 됩니다. 익숙한 몬스터들이겠지만 의외로 강할지도 모르니 주의해 주세요. 그럼 힘내주세요!"
local LACK = "아직 #b차원의 통행증 25장#k은 모으지 못하신 모양이지요? 맵 이곳 저곳에 있는 몬스터들을 잡고 나온 차원의 통행증을 파티장이 모아 제게 가져다 주시면 됩니다."
