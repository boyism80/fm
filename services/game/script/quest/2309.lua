...
return {
	on_start = function(me, npc)
		...
		me:dialog(npc, "다름이 아니라 #머쉬킹 왕국#k에 지금 큰 위기가 닥쳤다네. 머쉬킹 왕국은 헤네시스 근처에 위치한 버섯왕국으로써 선왕인 머쉬킹은 평화를 사랑하고 현명한 정치를 펼치는 분으로 명망이 높은 분이셨지. 그런데 최근에 건강이 악화되어 그의 하나 뿐인 딸 #b비올레타 공주#k에게 왕위를 물려주고 요양 중이라고 알고 있었는데 무슨 변고가 생긴 모양이네.", false, true)
