...
return {
	on_end = function(me, npc)
		...
		if me:meso() < 2000 then
			me:dialog(npc, "2000메소가 없는 것 같다.")
			return
		end

		me:dialog(npc, "#b(거미줄로 범벅이 된 구겨진 종이조각을 꺼냈다. 그리고 2000메소를 넣었다..)", false, true)

		local code = me:exchange({ meso = 2000 }, { item = { [4031894] = 1 } })
