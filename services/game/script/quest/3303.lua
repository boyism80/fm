...
return {
	on_end = function(me, npc)
		...
		if #choices == 0 then
			me:dialog(npc, "오호... 표정을 보아하니 거래할 준비가 된 모양이군. 그렇게 까지 해서 알카드노에 가입하고 싶다니... 이해할 수 없지만, 뭐 좋아. 우선 그렇다면 내게 #b아무 보석의 원석 두개#k를 가져오게.", false, false)
			return
		end

		local str = "오호... 표정을 보아하니 거래할 준비가 된 모양이군. 그렇게 까지 해서 알카드노에 가입하고 싶다니... 이해할 수 없지만, 뭐 좋아. 댓가로 무엇을 주겠어?\r\n\r\n#b"
		...
		me:dialog(npc, "그럼 잠시만 기다려. 네가 알카드노 협회장의 시험을 통과하도록 만들어줄, 그 물건을 구해 놓을테니.", false, true)
