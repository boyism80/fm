...
function on_quest_start_1201(me)
...
function on_quest_try_1201(me)
	on_quest_start_1201(me)
	local quest = me:quest(quest_id)
	if quest == nil then
		return
	end
...
local function finish_one_1201(me)
	on_quest_start_1201(me)
	local quest = me:quest(quest_id)
	if quest == nil then
		return
