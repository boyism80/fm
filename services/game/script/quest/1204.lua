...
function on_quest_start_1204(me)
	...
	quest:record_ex("have0", "0")
	quest:record_ex("have1", "0")
	quest:record_ex("have2", "0")
	quest:record_ex("have3", "0")
...
function on_quest_try_1204(me)
	on_quest_start_1204(me)
	local quest = me:quest(quest_id)
	if quest == nil then
		return
	end
...
local function finish_one_1204(me)
	on_quest_start_1204(me)
	local quest = me:quest(quest_id)
	if quest == nil then
		return
