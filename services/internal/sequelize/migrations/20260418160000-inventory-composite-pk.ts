...
const migration: MigrationModule = {
    async up(queryInterface) {
        ...
        await sequelize.query("ALTER TABLE inventory ADD COLUMN IF NOT EXISTS inventory_type SMALLINT;");
        await sequelize.query("UPDATE inventory SET inventory_type = 1 WHERE slot < 0;");
        ...
        `);
        await sequelize.query("ALTER TABLE inventory ALTER COLUMN inventory_type SET NOT NULL;");
        await sequelize.query(`
        ...
        `);
        await sequelize.query("CREATE INDEX IF NOT EXISTS idx_inventory_owner ON inventory (owner_id);");
    },
    ...
    async down(queryInterface) {
        ...
        await sequelize.query("ALTER TABLE inventory DROP CONSTRAINT IF EXISTS inventory_pkey");
        await sequelize.query("ALTER TABLE inventory ADD COLUMN IF NOT EXISTS deleted BOOLEAN NOT NULL DEFAULT FALSE;");
        await sequelize.query("ALTER TABLE inventory ADD COLUMN IF NOT EXISTS id BIGSERIAL NOT NULL;");
        await sequelize.query("ALTER TABLE inventory ADD CONSTRAINT inventory_pkey PRIMARY KEY (id);");
        await sequelize.query(
