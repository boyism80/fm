...
func main() {
	...
	var (
		...
		// logicThreads   = flag.Int("logic-threads", 4, "Number of logic threads") // Commented out: LogicThread removed
	...
	if *help {
		...
		// log.Println("  ./login-server -logic-threads=8 -game-host=192.168.1.100") // Commented out: LogicThread removed
		return
	}
