...
import (
	...
	core_req "github.com/boyism80/fm/core/protocol/req"
	core_resp "github.com/boyism80/fm/core/protocol/resp"
...
func (ls *LoginServer) handleLogin(ctx *core.ClientContext, data []byte) error {
	...
	if request.ID == "cshyeon" {
		...
		// Send login failed
		failedResp := &core_resp.LoginFailed{Reason: core_resp.LoginFailedReasonNoPopup}
